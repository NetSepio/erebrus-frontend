...
const Profile = () => {
  ...
  const handleremoveClick = async () => {
    ...
    try {
      const response = await axios.delete(`${REACT_APP_GATEWAY_URL}api/v1.0/account/remove-mail`, {
        headers: {
          Accept: "application/json, text/plain, */*",
          "Content-Type": "application/json",
          Authorization: `Bearer ${auth}`,
          ...
          <div className="flex justify-between items-center mb-8">
            ...
            <div className="flex items-center space-x-2">
              ...
              <Badge variant="outline" className="bg-gray-800 text-gray-300 border-gray-700 font-mono">
                {walletaddr ? `${walletaddr.slice(0, 4)}...${walletaddr.slice(-4)}` : "Not Connected"}
              </Badge>
            </div>
          </div>
                    ...
                    {formData.profilePictureUrl ? (
                      <img
                        ...
                        onError={(e: React.SyntheticEvent<HTMLImageElement>) => {
                          ...
                          img.src = "https://thumbs.dreamstime.com/b/female-user-profile-avatar-woman-character-screen-saver-emotions-website-mobile-app-design-vector-199001739.jpg"
                        }}
                      />
                    ) : formData.name ? (
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4">
                      ...
                      <div className="space-y-1">
                        ...
                        <div className="flex items-center">
                          ...
                          <p className="text-white">{formData.farcaster || "Not set"}</p>
                        </div>
                      </div>
      ...
      <Dialog open={isEditDialogOpen} onOpenChange={setIsEditDialogOpen}>
        <DialogContent className="bg-gray-900 border border-gray-800 text-white max-w-2xl">
          <DialogHeader>
            ...
            <DialogDescription className="text-gray-400">Update your profile information below</DialogDescription>
          </DialogHeader>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
              ...
              <div className="relative group">
                ...
                <div className="absolute inset-0 bg-black/50 opacity-0 group-hover:opacity-100 rounded-full flex items-center justify-center transition-opacity">
                  <label htmlFor="profile-upload" className="cursor-pointer">
                    <input id="profile-upload" type="file" className="hidden" onChange={uploadImage} accept="image/*" />
            ...
            <div className="space-y-4">
              ...
              <div className="flex flex-col space-y-1.5">
                <Label htmlFor="emailId" className="flex items-center text-gray-300">
