...
const NodesData = () => {
  ...
  const fetchNodesData = async () => {
    try {
      ...
      if (
        ...
        const filteredNodes = response.data.payload.filter(
          (node) => node.walletAddress === erebrusWallet
        );
  ...
  return (
    <div className="bg-gray-900 text-white p-6 rounded-lg shadow-lg">
      <h2 className="text-3xl font-bold mb-6">DVPN Nodes Dashboard</h2>
              ...
              {nodesdata.map((node) => (
                ...
                >
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    ...
                    {node.downloadSpeed.toFixed(2)}
                    <span className="ml-2 text-yellow-400">↑</span>{" "}
                    {node.uploadSpeed.toFixed(2)}
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <span
