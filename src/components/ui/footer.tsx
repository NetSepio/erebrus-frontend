        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div className="space-y-6">
            ...
            <p className="text-sm text-gray-300">
              Redefining digital connectivity by unlocking a secure, private, and globally accessible internet through
              the power of DePIN.
            </p>
          ...
          <div>
            ...
            >
              ...
              <ChevronUp
                className={`md:hidden transition-transform duration-300 ${expanded.explore ? "transform rotate-180" : ""}`}
                size={18}
                />
            </div>
            <ul
          ...
          <div>
            ...
            >
              ...
              <ChevronUp
                className={`md:hidden transition-transform duration-300 ${expanded.getErebrus ? "transform rotate-180" : ""}`}
                size={18}
              />
            </div>
            <ul
          ...
          <div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              {subscribed && <div className="text-green-400 text-sm">Thanks for subscribing!</div>}
            </form>
          </div>
        </div>
