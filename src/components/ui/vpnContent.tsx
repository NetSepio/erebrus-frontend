...
export default function VPNContentSection() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      const elementPosition = document.getElementById("vpn-content")?.offsetTop || 0
  ...
  const cards = [
    ...
    },
    {
      ...
      description: "Optimized routing and high-performance nodes ensure minimal latency.",
      icon: <Zap className="w-8 h-8 text-blue-300" />,
      delay: "450",
    },
    {
      title: "Global Coverage",
      description: "Access content from anywhere with our worldwide node network.",
      icon: <Globe className="w-8 h-8 text-blue-300" />,
      delay: "600",
    },
    {
      title: "Military-Grade Encryption",
    description: "Your data is protected with the highest level of encryption available.",
  ...
  return (
    <div id="vpn-content" className="bg-gradient-to-b from-gray-900 to-black min-h-screen text-white py-24 px-6">
      <div
        className={`max-w-6xl mx-auto transition-all duration-1000 ${visible ? "opacity-100 transform translate-y-0" : "opacity-0 transform translate-y-10"}`}
      >
        {/* Header */}
        ...
        <div className="flex flex-wrap justify-center gap-6 mt-12">
          <button className="px-8 py-4 bg-gray-800 hover:bg-gray-700 text-white rounded-lg transition-all duration-300 border border-gray-700 hover:border-gray-500 flex items-center group shadow-lg hover:shadow-blue-900/20">
            <span className="transform transition-transform group-hover:translate-x-1 text-lg">Deploy Your Node</span>
            <svg
          ...
          <button className="px-8 py-4 bg-blue-600 text-white hover:bg-blue-500 rounded-lg transition-all duration-300 shadow-lg hover:shadow-blue-600/30 flex items-center group">
            <span className="transform transition-transform group-hover:translate-x-1 text-lg">Launch Agent</span>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
