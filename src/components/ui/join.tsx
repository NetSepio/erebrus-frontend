      ...
      <div className="flex items-center justify-center min-h-screen w-full bg-gblack text-white p-6">
        <div className="flex flex-col items-center justify-center max-w-3xl text-center relative p-8">
          ...
          <div className="relative mb-10 flex flex-col items-center">
            {/* Hexagon logo */}
            <div
              className="w-20 h-20 mb-3 flex items-center justify-center bg-gradient-to-br from-blue-400 to-blue-700 shadow-lg shadow-blue-500/20"
              style={{
                clipPath:
            ...
            <p className="text-sm text-gray-400 mt-1">powered by NetSepio</p>
          </div>
