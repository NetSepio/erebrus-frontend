...
const Mission = () => {
  return (
    <div className="flex justify-center bg-[#040a20] pt-32">
      <div className="relative w-xl flex items-center justify-center border-white border border-1 rounded-3xl">
        <div
        ...
        <div className="relative max-w-6xl p-10 lg:p-20 text-center rounded-lg text-white">
